...
class DataEncoderHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        exchange.getResponseHeaders().add("Access-Control-Allow-Origin", "https://cloud.temporal.io");
        exchange.getResponseHeaders().add("Access-Control-Allow-Headers", "X-Namespace, Content-Type");
        exchange.getResponseHeaders().add("Access-Control-Allow-Credentials", "true");
       // exchange.getResponseHeaders().add("X-FRG-RC", "12345");
