...
package com.antmendoza.temporal.schedule;
...
public class HelloSchedules {
    ...
    static final String WORKFLOW_ID = "HelloScheduleWorkflow_no_DC";

    // Define the schedule unique id
    static final String SCHEDULE_ID = "HelloSchedule_no_DC";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WorkflowServiceStubs service = ClientFactory.getWorkflowClient().getWorkflowServiceStubs();


        ScheduleClient scheduleClient = ScheduleClient.newInstance(service, ScheduleClientOptions
                .newBuilder()
                .setDataConverter(
                        new CodecDataConverter(
                                DefaultDataConverter.newDefaultInstance(),
                                Collections.singletonList(new CryptCodec())))
                .setNamespace(ClientFactory.getSslContextBuilderProvider().getNamespace())
                .build());
        ...
        final Map<String, Payload> text =
                Map.of("tmd",
                        Payload.newBuilder()
                                .setData(ByteString.
                                        copyFromUtf8("{\"X-FRG-RC\":\"VALUE\"}")).build());

        ScheduleActionStartWorkflow action =
                ScheduleActionStartWorkflow.newBuilder()
                        .setWorkflowType(GreetingWorkflow.class)
                        .setArguments("World")
                        .setHeader(new Header(text))
...
//
//
//                    final Map<String, Payload> text_2 =
//                            Map.of("tmd",
//                                    Payload.newBuilder()
//                                            .setData(ByteString.
//                                                    copyFromUtf8("{\"X-FRG-RC\":\"VALUE_2\"}")).build());
//
//                    ScheduleActionStartWorkflow action_2 =
//                            ScheduleActionStartWorkflow.newBuilder()
//                                    .setWorkflowType(GreetingWorkflow.class)
//                                    .setArguments("World")
//                                    .setHeader(new Header(text_2))
//                                    .setOptions(workflowOptions)
//                                    .build();
//
//
//                    builder.setAction(action_2).build();
//
//
//
