...
import static com.antmendoza.WorkflowCode_from_jpmc_code.createAsyncChildWorkflow;
import static com.antmendoza.WorkflowCode_from_jpmc_code.TASK_QUEUE;

public class WorkflowCodeReplayTest_jpmc_code {
    ...
    public void replayWorkflowExecution() throws Exception {
        ...
        final Class<WorkflowCode_from_jpmc_code.MyWorkflowJPMCCodeImpl> workflowImplementationType =
                WorkflowCode_from_jpmc_code.MyWorkflowJPMCCodeImpl.class;

        createWorker(WorkflowCode_from_jpmc_code.MyWorkflowJPMCCodeImpl.class);
    ...
    private String executeMainWorkflow() {
        ...
        WorkflowCode_from_jpmc_code.MyWorkflowJPMCCode workflow =
                testWorkflowRule
                        .getWorkflowClient()
                        .newWorkflowStub(
                                WorkflowCode_from_jpmc_code.MyWorkflowJPMCCode.class,
    ...
    public static class MyWorkflowImplWithGetChildPromiseVersioned
            implements WorkflowCode_from_jpmc_code.MyWorkflowJPMCCode {
        ...
        public String getGreeting(String name) {
            ...
            final WorkflowCode_from_jpmc_code.MyChildWorkflow child_1 = createAsyncChildWorkflow(name, childWorkflow1, TASK_QUEUE);
            ...
            final WorkflowCode_from_jpmc_code.MyChildWorkflow child_2 = createAsyncChildWorkflow(name, childWorkflow2, TASK_QUEUE);
