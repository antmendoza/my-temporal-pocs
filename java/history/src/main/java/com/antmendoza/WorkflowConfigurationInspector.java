...
public class WorkflowConfigurationInspector {
    ...
    public WorkflowConfigurationInspector(final WorkflowExecutionHistoryData workflowExecutionHistoryData) {
    ...
    public ConfigurationInspectorResult feedback() {
        ...
        this.advisorList.forEach(ad -> {
            configurationInspectorResult.addTip(ad.inspectActivities(this.workflowExecutionHistoryData.getActivityDataList()));
        });
