...
package io.antmendoza.samples._6527;
...
public class HelloSchedules {
  ...
  public interface GreetingActivities {
    ...
    Instant getScheduleInfo(String scheduleId) ;
  }
  ...
  public static class GreetingWorkflowImpl implements GreetingWorkflow {
    ...
    public void greet(String name) {
      ...
      Instant nextScheduledInit = activities.getScheduleInfo(scheduledByID);
      System.out.println("----------------------------------------------------------" );
      System.out.println("nextScheduledInit " + nextScheduledInit);
      ...
      Instant nextScheduledEnd = activities.getScheduleInfo(scheduledByID);


      Workflow.sleep(7000);

      System.out.println("nextScheduledEnd " + nextScheduledEnd);
  ...
  static class GreetingActivitiesImpl implements GreetingActivities {
    ...
    public GreetingActivitiesImpl(final  ScheduleClient scheduleClient) {
      this.scheduleClient = scheduleClient;
    }

    @Override
    public Instant getScheduleInfo(String scheduleId) {
      return this.scheduleClient.getHandle(scheduleId).describe().getInfo().getNextActionTimes().get(0);
    }
  }
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    worker.registerActivitiesImplementations(new GreetingActivitiesImpl(scheduleClient));
    ...
    while (true) {
      ...
      System.out.println(handle.describe().getInfo().getNumActionsSkippedOverlap());
