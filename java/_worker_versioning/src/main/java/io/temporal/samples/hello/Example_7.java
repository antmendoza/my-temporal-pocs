...
public class Example_7 {
    ...
    public static void main(String[] args) {
        ...
        {
            Class<GreetingWorkflowImpl_withNDE> greetingWorkflowImplWithNDEClass = GreetingWorkflowImpl_withNDE.class;
            final WorkerFactory factory = startWorker(client, greetingWorkflowImplWithNDEClass);
            ...
            CompletableFuture.runAsync(()->{
                ...
                Class<GreetingWorkflowImpl_withNDE_fixed> greetingWorkflowImpl_withNDE_fixedClass = GreetingWorkflowImpl_withNDE_fixed.class;

                final WorkerFactory factory_2 = startWorker(client, greetingWorkflowImpl_withNDE_fixedClass);
    ...
    private static WorkerFactory startWorker(WorkflowClient client, Class<?> greetingWorkflowImplWithNDEClass) {
        ...
        worker.registerWorkflowImplementationTypes(
                WorkflowImplementationOptions.newBuilder().setEnableUpsertVersionSearchAttributes(true).build(),
                greetingWorkflowImplWithNDEClass
                );
